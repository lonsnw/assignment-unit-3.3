...
console.log(`second item from array:`, secondItem);
...
console.log(`supply changes with last value removed:`, supplyChanges);
console.log(`last value:`, removedItem);

// 5. A delivery of 25 more parts arrived. Add the value 25 to the end of the array
console.log('5. Add the value 25 into supplyChanges.');
supplyChanges.push(25);
console.log(`supply changes with new arrival:`, supplyChanges);
...
console.log(`supplyChanges:`, supplyChanges);
let totalParts = 0;
let x = supplyChanges.length-1;
//noting for myself: i got stuck here because i wasn't subtracting 1 from the length
//and i assume that the loop wasn't working because it was looking for a value
//that did not exist because the index number was referring to a value 
...
console.log(`sum of supplyChanges:`, totalParts);
...
//this works with += 1 but not with ++, not sure why
}
